...
Write-Host "`n[1/9] Verifying AWS credentials..." -ForegroundColor Yellow
...
Write-Host "`n[2/9] Installing CDK dependencies..." -ForegroundColor Yellow
...
Write-Host "`n[3/9] Installing frontend dependencies..." -ForegroundColor Yellow
